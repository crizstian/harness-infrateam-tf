  ...
  packer_hashistack_gcp = {
    ...
    components = {
      ...
      inputset = {
        gcp = {
          enable      = true
          file        = "templates/dev/inputsets/packer-hashistack-gcp.tpl"
  ...
  nomad_cluster_gcp = {
    components = {
      ...
      inputset = {
        sto = {
          enable      = true
          file        = "templates/dev/inputsets/sto_nomad_cluster_gcp.tpl"
          description = "Inputset generated by terraform harness provider"
        ...
        apply = {
          enable      = true
          file        = "templates/dev/inputsets/nomad_cluster_gcp.tpl"
          description = "Inputset generated by terraform harness provider"
          tags        = ["component: nomad"]
          vars = {
            tf_folder         = "gcp"
